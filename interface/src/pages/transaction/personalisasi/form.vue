    ...
    <s-drawer @refresh='refresh' :useModal='useModal' form @submit='submit' @back='back' :Meta='Meta'>
      <div>
        <s-form class='q-px-md q-py-lg' title='Form Personalisasi'>
          ...
          <t-currency col='12' label='age' currency v-model='model.age' topLabel='age' />
          <t-currency col='12' label='kehamilan_ke' currency v-model='model.kehamilan_ke' topLabel='kehamilan_ke' />
          <t-currency col='12' label='usia_anak_terakhir' currency v-model='model.usia_anak_terakhir'
            topLabel='usia_anak_terakhir' />
          <t-input col='12' label='hpht' v-model='model.hpht' topLabel='hpht' />
          <t-currency col='12' label='usia_kehamilan' currency v-model='model.usia_kehamilan' topLabel='usia_kehamilan' />
          <t-input col='12' label='gph' v-model='model.gph' topLabel='gph' />
