...
export default [
   ...
   { name: 'lesson-timetable', path: 'lesson-timetable', component: () => import('pages/master/lesson-timetable/index.vue') },
   { name: 'add-lesson-timetable', path: 'lesson-timetable/form', component: () => import('pages/master/lesson-timetable/form.vue') },
   { name: 'edit-lesson-timetable', path: 'lesson-timetable/form/:id', component: () => import('pages/master/lesson-timetable/form.vue') },
   { name: 'view-lesson-timetable', path: 'lesson-timetable/:id', component: () => import('pages/master/lesson-timetable/detail.vue') },
