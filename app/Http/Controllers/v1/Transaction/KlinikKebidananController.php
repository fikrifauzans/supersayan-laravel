...
use App\Repositories\V1\Eloquent\Transaction\KlinikKebidananRepository;
...
class KlinikKebidananController extends Controller
    {
    /**
    ...
    */
    ...
    public function __construct(KlinikKebidananRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
    ...
    public function index(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'klinik-kebidanan-index' )) return $this->response->error($language, 'permission-denied');
    ...
    public function show($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'klinik-kebidanan-show' )) return $this->response->error($language, 'permission-denied');
    ...
    public function store(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'klinik-kebidanan-store' )) return $this->response->error($language, 'permission-denied');
    ...
    public function update(Request $request,  $language, $id)
    {
        ...
        if (Gate::denies('permission',  'klinik-kebidanan-update' )) return $this->response->error($language, 'permission-denied');
    ...
    public function destroy($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'klinik-kebidanan-destroy' )) return $this->response->error($language, 'permission-denied');
    ...
    public function force($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'klinik-kebidanan-force' )) return $this->response->error($language, 'permission-denied');
    ...
    public function restore($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'klinik-kebidanan-restore' )) return $this->response->error($language, 'permission-denied');
