...
use App\Repositories\V1\Eloquent\Transaction\KonselingRepository;
...
class KonselingController extends Controller
    ...
    */
    ...
    public function __construct(KonselingRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
    ...
    public function index(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'konseling-index' )) return $this->response->error($language, 'permission-denied');
    ...
    public function show($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'konseling-show' )) return $this->response->error($language, 'permission-denied');
    ...
    public function store(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'konseling-store' )) return $this->response->error($language, 'permission-denied');
    ...
    public function update(Request $request,  $language, $id)
    {
        ...
        if (Gate::denies('permission',  'konseling-update' )) return $this->response->error($language, 'permission-denied');
    ...
    public function destroy($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'konseling-destroy' )) return $this->response->error($language, 'permission-denied');
    ...
    public function force($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'konseling-force' )) return $this->response->error($language, 'permission-denied');
    ...
    public function restore($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'konseling-restore' )) return $this->response->error($language, 'permission-denied');
