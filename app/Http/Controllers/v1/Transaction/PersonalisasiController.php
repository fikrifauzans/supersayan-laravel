...
use App\Repositories\V1\Eloquent\Transaction\PersonalisasiRepository;
...
class PersonalisasiController extends Controller
    ...
    */
    ...
    public function __construct(PersonalisasiRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
    ...
    public function index(Request $request, $language)
    {
        ...
        // if (Gate::denies('permission',  'personalisasi-index' )) return $this->response->error($language, 'permission-denied');
    ...
    public function show($language, $id, Request $request)
    {
        ...
        // // if (Gate::denies('permission',  'personalisasi-show' )) return $this->response->error($language, 'permission-denied');
    ...
    public function store(Request $request, $language)
    {
        ...
        // // if (Gate::denies('permission',  'personalisasi-store' )) return $this->response->error($language, 'permission-denied');
    ...
    public function update(Request $request,  $language, $id)
    {
        ...
        // // if (Gate::denies('permission',  'personalisasi-update' )) return $this->response->error($language, 'permission-denied');
    ...
    public function destroy($language, $id, Request $request)
    {
        ...
        // // if (Gate::denies('permission',  'personalisasi-destroy' )) return $this->response->error($language, 'permission-denied');
    ...
    public function force($language, $id, Request $request)
    {
        ...
        // // if (Gate::denies('permission',  'personalisasi-force' )) return $this->response->error($language, 'permission-denied');
    ...
    public function restore($language, $id, Request $request)
    {
        ...
        // // if (Gate::denies('permission',  'personalisasi-restore' )) return $this->response->error($language, 'permission-denied');
