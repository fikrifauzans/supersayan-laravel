...
use App\Repositories\V1\Eloquent\Transaction\RekapSimulasiRepository;
...
class RekapSimulasiController extends Controller
    ...
    */
    ...
    public function index(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'rekap-simulasi-index' )) return $this->response->error($language, 'permission-denied');
    ...
    public function show($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'rekap-simulasi-show' )) return $this->response->error($language, 'permission-denied');
    ...
    public function store(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'rekap-simulasi-store' )) return $this->response->error($language, 'permission-denied');
        ...
        return $this->response->choseLang($language)->modeMessage('create', $this->repository->getTableName())->success($this->repository->transformStore($request->all()));
    }
                
    public function update(Request $request,  $language, $id)
    {
                
        if (Gate::denies('permission',  'rekap-simulasi-update' )) return $this->response->error($language, 'permission-denied');
    ...
    public function destroy($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'rekap-simulasi-destroy' )) return $this->response->error($language, 'permission-denied');
    ...
    public function force($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'rekap-simulasi-force' )) return $this->response->error($language, 'permission-denied');
    ...
    public function restore($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'rekap-simulasi-restore' )) return $this->response->error($language, 'permission-denied');
