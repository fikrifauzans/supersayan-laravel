...
use App\Repositories\V1\Eloquent\Transaction\TransactionDetailsRepository;
...
class TransactionDetailsController extends Controller
    ...
    */
    ...
    public function index(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'transaction-details-index' )) return $this->response->error($language, 'permission-denied');
    ...
    public function show($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'transaction-details-show' )) return $this->response->error($language, 'permission-denied');
    ...
    public function store(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'transaction-details-store' )) return $this->response->error($language, 'permission-denied');
    ...
    public function update(Request $request,  $language, $id)
    {
        ...
        if (Gate::denies('permission',  'transaction-details-update' )) return $this->response->error($language, 'permission-denied');
    ...
    public function destroy($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'transaction-details-destroy' )) return $this->response->error($language, 'permission-denied');
    ...
    public function force($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'transaction-details-force' )) return $this->response->error($language, 'permission-denied');
    ...
    public function restore($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'transaction-details-restore' )) return $this->response->error($language, 'permission-denied');
