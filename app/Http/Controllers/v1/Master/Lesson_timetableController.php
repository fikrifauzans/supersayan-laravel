...
use App\Repositories\V1\Eloquent\Master\Lesson_timetableRepository;
...
class Lesson_timetableController extends Controller
    {
    /**
    ...
    */
    ...
    public function __construct(Lesson_timetableRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
    ...
    public function index(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'lesson_timetable-index' )) return $this->response->error($language, 'permission-denied');
    ...
    public function show($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'lesson_timetable-show' )) return $this->response->error($language, 'permission-denied');
    ...
    public function store(Request $request, $language)
    {
        ...
        if (Gate::denies('permission',  'lesson_timetable-store' )) return $this->response->error($language, 'permission-denied');
    ...
    public function update(Request $request,  $language, $id)
    {
        ...
        if (Gate::denies('permission',  'lesson_timetable-update' )) return $this->response->error($language, 'permission-denied');
    ...
    public function destroy($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'lesson_timetable-destroy' )) return $this->response->error($language, 'permission-denied');
    ...
    public function force($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'lesson_timetable-force' )) return $this->response->error($language, 'permission-denied');
    ...
    public function restore($language, $id, Request $request)
    {
        ...
        if (Gate::denies('permission',  'lesson_timetable-restore' )) return $this->response->error($language, 'permission-denied');
