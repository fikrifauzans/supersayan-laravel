...
use App\Repositories\V1\Eloquent\Master\ContactsRepository;
...
class ContactsController extends Controller
{
    ...
    public function __construct(ContactsRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
