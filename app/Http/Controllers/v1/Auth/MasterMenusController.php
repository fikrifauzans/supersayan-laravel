...
use App\Repositories\V1\Eloquent\Auth\MasterMenusRepository;
...
class MasterMenusController extends Controller
{
    ...
    public function __construct(MasterMenusRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
    ...
    public function store(Request $request, $language)
    {
        ...
        else  $this->response->choseLang($language)->modeMessage('create', $this->repository->getTableName())->success($this->repository->updateOrCreateOnRepo(null, $request->all()));
    }
    ...
    public function update(Request $request,  $language, $id)
    {
        ...
        return $this->response->choseLang($language)->modeMessage('update', $this->repository->getTableName())->success($this->repository->updateOrCreateOnRepo($id, $request->all()));
    }
