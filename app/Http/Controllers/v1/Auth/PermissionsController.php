...
use App\Repositories\V1\Eloquent\Auth\PermissionsRepository;
...
class PermissionsController extends Controller
{
    ...
    public function __construct(PermissionsRepository $repository, CustomValidator $validator, JsonCustomResponse $response)
    {
